...
export class KiftVans__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class KiftVans extends ethereum.SmartContract {
  static bind(address: Address): KiftVans {
    return new KiftVans("KiftVans", address);
  }
  ...
  royaltyInfo(
    ...
    return new KiftVans__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    _tokenId: BigInt,
    _salePrice: BigInt
  ): ethereum.CallResult<KiftVans__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new KiftVans__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
